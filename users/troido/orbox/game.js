...
define(["lib/inheritance", "field", "loadfile", "blocks", "player"], function(Class, Field, loadFile, Blocks, Player){
	...
	var Game = Class.extend({
		...
		startLevel: function(){
			...
			this.field = new Field(level, Blocks);
		...
		getCurrentLevelDescription: function(){
			return this.levels[this.currentLevel].description;
		}
	});
	return Game;
});
